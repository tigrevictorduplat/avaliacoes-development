	...
	return (
		<ScrollView contentContainerStyle={{ paddingBottom: 800, paddingTop: 20 }}>
			...
			<View className="items-center justify-center mt-16 ">
				<Text
					className="text-[22px] font-semibold text-[#b8860b] rounded p-1"
				...
				<TouchableOpacity
					...
					className="bg-[#fff700] h-[50px] w-[90%] rounded-md justify-between items-center flex-row px-4 mt-4"
				>
					<Text
						className="text-[14px] font-Regular text-black"
						style={{ fontFamily: 'poppins-medium' }}
					>
				...
				{isExpanded && (
					<View className="bg-[#ffd750] w-[90%] mt-2 p-3 rounded-md">
						<Text
				...
				<Text
					className="text-[18px] font-semibold text-[#b8860b] rounded p-1 mt-16"
					style={{ fontFamily: 'poppins-medium' }}
				>
